...
export class AccountEdit {
  ...
  constructor(private mikiPerson: MikiPersonService, private mikiEvents: MikiEventsService, public mikiPublicite: MikiPubliciteService, private events: Events, private alertCtrl: AlertController, private loadingCtrl: LoadingController, private navParams: NavParams, public toastCtrl: ToastController) {
